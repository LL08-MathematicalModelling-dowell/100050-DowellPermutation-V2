...
import {
  assignSetN,
  assignSetR,
  assignPermutationResult,
  resetN,
  resetR,
  resetPermutationResult,
    ...
    <div className="permutationInputs">
      <form>
        <img
          ...
          alt="logo"
        />
        <h1 className="heading">DoWell Permutations Calculator</h1>
        ...
        <div
          ...
          id={showButtons ? "formButtons" : ""}
        >
          <button className="resetButton" onClick={handleReset}>
            Reset
          </button>
          <button className="calculateButton" onClick={calculatePermutation}>
            Calculate
          </button>
        </div>
        <div
          className="permutationResults"
          id={showButtons ? "formResults" : ""}
        >
          <p>
            Number of Permutations ={" "}
            <span className="amount">{permutationResult}</span>
          </p>
